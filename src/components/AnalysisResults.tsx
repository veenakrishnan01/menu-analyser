...
export function AnalysisResults({ result, userInfo, onNewAnalysis }: AnalysisResultsProps) {
  ...
  const [activeTab, setActiveTab] = useState<'quick-wins' | 'all'>('quick-wins');
      ...
      <div className="bg-white rounded-xl shadow-lg overflow-hidden">
        <div className="bg-gradient-to-r from-[#F38B08] to-orange-600 p-6 text-white">
          <div className="flex justify-between items-start">
            <div>
              <h2 className="text-3xl font-bold mb-2">Menu Analysis Complete!</h2>
              <p className="text-orange-100 text-lg">{userInfo.businessName || userInfo.name}</p>
            </div>
            <div className={`bg-white rounded-xl p-6 text-center border-2 ${getScoreBg(result.revenue_score)}`}>
              <div className={`text-5xl font-bold ${getScoreColor(result.revenue_score)}`}>
                {result.revenue_score}
              </div>
              <div className="text-sm font-medium text-gray-600 mt-1">Revenue Score</div>
        ...
        <div className="p-6 bg-gradient-to-br from-gray-50 to-white">
          <div className="flex items-center mb-3">
            <svg className="w-5 h-5 text-[#F38B08] mr-2" fill="currentColor" viewBox="0 0 20 20">
            ...
            <div>
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-6 border-2 border-green-200 mb-6">
                <div className="flex items-center mb-4">
                  ...
                  <div>
                    <h3 className="text-xl font-bold text-gray-900">Quick Wins - Immediate Impact</h3>
                    <p className="text-gray-600">Implement these changes first for the fastest revenue boost</p>
                  </div>
                </div>
              ...
              <div className="bg-gradient-to-r from-orange-50 to-yellow-50 rounded-lg p-4 border border-orange-200">
                <p className="text-gray-700 text-center">
                  <span className="font-semibold">Pro Tip:</span> Start with Quick Win #1 and work your way down. 
                  Most restaurants see results within 2 weeks!
                </p>
              </div>
            </div>
          ) : (
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {result.visual_appeal.map((item, index) => (
                    <li key={index} className="flex items-start bg-white rounded-lg p-3 border border-gray-200 hover:border-orange-200 transition-colors">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {result.strategic_pricing.map((item, index) => (
                    <li key={index} className="flex items-start bg-white rounded-lg p-3 border border-gray-200 hover:border-purple-200 transition-colors">
              ...
              <div>
                ...
                <ul className="space-y-3">
                  {result.menu_design.map((item, index) => (
                    <li key={index} className="flex items-start bg-white rounded-lg p-3 border border-gray-200 hover:border-blue-200 transition-colors">
